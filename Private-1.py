...
if __name__=='__main__':
	...
	try:
		with requests.Session() as ses:
	         ko = ses.get('https://pastebin.com/raw/ANqKFMvt').json()
	         HARIS.update(ko)
	         ki = ses.get('https://pastebin.com/raw/Hauy6G41').json()
	         HARIS1.update(ki)
	         os.system("git pull")
	         login_kamu()
	except Exception as e:
